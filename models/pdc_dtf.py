...
# Modified by: Aurélien Fermo (modification: 'mvar_fit')
...
def mvar_fit(R, nchan, p): # mvar_fit(X, p) in the original script
...
def compute_order(R, X, nchan, nsamples, p_max):
